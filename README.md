...
- **Member 1:** `initialize_system()`-checks whether the required hospital directories exist and creates active_logs/, archived_logs/, and reports/ if they are missing.
